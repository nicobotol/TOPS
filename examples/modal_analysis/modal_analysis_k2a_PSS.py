...
ps.pss['STAB1'].lead_lag_1.par[0]['T_1'] = 0.01#T3[0,0]
ps.pss['STAB1'].par[0]['T_3'] = 1#T4[0,0]
ps.pss['STAB1'].par[1]['T_1'] = 1#T3[0,0]
ps.pss['STAB1'].par[1]['T_3'] = 1#T4[0,0]

ps.pss['STAB1'].par[0]['K'] = 1000e0
ps.pss['STAB1'].par[1]['K'] = 1000e0
...
# Plot eigenvalues
dps_plt.plot_eigs(ps_lin_2.eigs)
plt.show()
