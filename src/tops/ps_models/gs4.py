def load():
    return {
        ...
        'lines': [
            ...
            ['L1-2',    'B1',       'B2',       1,          100,    230,    'p.u.',     0.01008,   0.05040,   2*0.05125],
            ['L1-3',    'B1',       'B3',       1,          100,    230,    'p.u.',     0.00744,   0.03720,   2*0.03875],
            ['L2-4',    'B2',       'B4',       1,          100,    230,    'p.u.',     0.00744,   0.03720,   2*0.03875],
            ['L3-4',    'B3',       'B4',       1,          100,    230,    'p.u.',     0.01272,   0.06360,   2*0.06375],
        ],
