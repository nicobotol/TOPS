def load():
    return {
        ...
        'lines': [
            ...
            ['L1-5',    'B1',       'B5',       25,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L5-6',    'B5',       'B6',       25,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L2-6',    'B2',       'B6',       25,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L3-11',   'B3',       'B11',      25,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L4-10',   'B4',       'B10',      25,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L6-7',    'B6',       'B7',       10,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L7-8-1',  'B7',       'B8',       110,        100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L7-8-2',  'B7',       'B8',       110,        100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L8-9-1',  'B8',       'B9',       110,        100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L8-9-2',  'B8',       'B9',       110,        100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L9-10',   'B9',       'B10',      10,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
            ['L10-11',  'B10',      'B11',      25,         100,    230,    'p.u.',     1e0*1e-4,   1e-3,   1e0*1.75e-3],
        ],
